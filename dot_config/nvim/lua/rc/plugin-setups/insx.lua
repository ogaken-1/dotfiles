local function pum_visible()
  return vim.fn.exists '*pum#visible' == 1 and vim.fn['pum#visible']()
end

local function wilder_visible()
  return 1 == vim.fn.exists '*wilder#in_context' and vim.fn['wilder#in_context']() == 1
end

local function vsnip_jumpable(count)
  return 1 == vim.fn.exists '*vsnip#jumpable' and 1 == vim.fn['vsnip#jumpable'](count)
end
...
local function denippet_jumpable(dir)
  return 1 == vim.fn.exists '*denippet#jumpable' and vim.fn['denippet#jumpable'](dir)
end
  ...
  insx.add(
    ...
    insx.compose {
      ...
      },
      {
        ...
        action = function(ctx)
          ctx.send '<Plug>(denippet-jump-prev)'
        end,
      },
      {
        priority = -1,
