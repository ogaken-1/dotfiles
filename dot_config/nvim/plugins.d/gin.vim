" hook_source {{{
" ORIGINAL:
"   SOURCE: https://github.com/kuuote/dotvim/blob/master/bundle/gin-preview.vim/plugin/gin_preview.vim
"   LICENSE: https://github.com/kuuote/dotvim/blob/master/LICENSE
