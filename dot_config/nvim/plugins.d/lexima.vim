...
call lexima#add_rule(#{ filetype: ['javascript', 'typescript'], char: '*', at: '\/\%#', input_after: '*/' })
call lexima#add_rule(#{ filetype: ['javascript', 'typescript'], char: '<Space>', at: '\/\*\{1,2}\%#\*\/', input_after: '<Space>' })
