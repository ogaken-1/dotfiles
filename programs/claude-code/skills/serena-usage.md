...
<tools>
  ...
  <tool name="mcp__serena__write_memory">
  ...
  <tool name="mcp__serena__delete_memory">
  ...
  <tool name="mcp__serena__edit_memory">
...
<concepts>
  <concept name="memory_files">
    ...
    <example scenario="Memory file operations">
      <step order="1" description="Check existing patterns">
        <call tool="mcp__serena__list_memories">
        </call>
      </step>
      <step order="2" description="Load Nix patterns">
        <call tool="mcp__serena__read_memory">
          <param name="memory_file_name">nix-conventions</param>
        </call>
      </step>
      <step order="3" description="Record new pattern">
        <call tool="mcp__serena__write_memory">
          <param name="memory_file_name">api-patterns</param>
          <param name="content">REST API conventions...</param>
        </call>
      </step>
      <step order="4" description="Remove obsolete info">
        <call tool="mcp__serena__delete_memory">
          <param name="memory_file_name">outdated-pattern</param>
        </call>
      </step>
    </example>
  </concept>
  ...
  <concept name="symbol_path">
    ...
    <example scenario="Symbol path usage patterns">
      <step order="1" description="Find specific method">
        <call tool="mcp__serena__find_symbol">
          <param name="name_path_pattern">MyClass/myMethod</param>
        </call>
      </step>
      <step order="2" description="Find all getter methods">
        <call tool="mcp__serena__find_symbol">
  ...
  <concept name="reflection_tools">
    ...
    <example scenario="Using reflection tools at appropriate checkpoints">
      <step order="1" description="After searching multiple files">
        <call tool="mcp__serena__think_about_collected_information">
        </call>
      </step>
      <step order="2" description="Before making changes">
        <call tool="mcp__serena__think_about_task_adherence">
        </call>
      </step>
      <step order="3" description="When task seems complete">
...
<patterns>
  <pattern name="explore_file">
    ...
    <example scenario="Exploring file structure progressively">
      <step order="1" description="Get top-level overview">
        <call tool="mcp__serena__get_symbols_overview">
          <param name="relative_path">src/main.ts</param>
          <param name="depth">0</param>
        </call>
      </step>
      <step order="2" description="Explore class members">
        <call tool="mcp__serena__get_symbols_overview">
          <param name="relative_path">src/main.ts</param>
          <param name="depth">1</param>
        </call>
      </step>
      <step order="3" description="Get specific implementation">
        <call tool="mcp__serena__find_symbol">
          <param name="name_path_pattern">MyClass/myMethod</param>
  ...
  <pattern name="trace_dependencies">
    ...
    <example scenario="Tracing symbol dependencies and callers">
      <step order="1" description="Locate the symbol">
        <call tool="mcp__serena__find_symbol">
          <param name="name_path_pattern">processData</param>
          <param name="relative_path">src/processor.ts</param>
        </call>
      </step>
      <step order="2" description="Find all callers">
        <call tool="mcp__serena__find_referencing_symbols">
          <param name="name_path">processData</param>
          <param name="relative_path">src/processor.ts</param>
        </call>
      </step>
      <step order="3" description="Recursively trace for full dependency graph">
  ...
  <pattern name="safe_refactoring">
    ...
    <example scenario="Safe refactoring with full impact analysis">
      <step order="1" description="Understand current implementation">
        <call tool="mcp__serena__find_symbol">
          <param name="name_path_pattern">MyClass/oldMethod</param>
          <param name="include_body">true</param>
        </call>
      </step>
      <step order="2" description="Identify all usages">
        <call tool="mcp__serena__find_referencing_symbols">
          <param name="name_path">MyClass/oldMethod</param>
          <param name="relative_path">src/myclass.ts</param>
        </call>
      </step>
      <step order="3" description="Perform the change">
      ...
      <step order="4" description="Update references if interface changed">
  ...
  <pattern name="pattern_search">
    ...
    <example scenario="Pattern search with different scopes">
      <step order="1" description="Search only in code files">
      ...
      <step order="2" description="Search in all files including configs">
        <call tool="mcp__serena__search_for_pattern">
          <param name="substring_pattern">api-key</param>
          <param name="restrict_search_to_code_files">false</param>
        </call>
      </step>
      <step order="3" description="Include context around matches">
        <call tool="mcp__serena__search_for_pattern">
  ...
  <pattern name="memory_workflow">
    ...
    <example scenario="Memory workflow for consistent implementation">
      <step order="1" description="Before implementation - check what patterns exist">
        <call tool="mcp__serena__list_memories">
        </call>
      </step>
      <step order="2" description="Before implementation - load relevant patterns">
        <call tool="mcp__serena__read_memory">
          <param name="memory_file_name">typescript-patterns</param>
        </call>
      </step>
      <step order="3" description="During implementation">
        <note>Follow the patterns loaded from memory</note>
      </step>
      <step order="4" description="After implementation - record new patterns">
        <call tool="mcp__serena__write_memory">
          <param name="memory_file_name">api-client-pattern</param>
          <param name="content">HTTP client pattern using fetch with retry logic...</param>
        </call>
      </step>
    </example>
  </pattern>
  ...
  <decision_tree name="tool_selection">
    ...
    <branch condition="Symbol lookup">Use mcp__serena__find_symbol with name_path_pattern</branch>
    <branch condition="File structure overview">Use mcp__serena__get_symbols_overview with appropriate depth</branch>
    <branch condition="Find references">Use mcp__serena__find_referencing_symbols</branch>
    <branch condition="Pattern search">Use mcp__serena__search_for_pattern with regex</branch>
    <branch condition="Refactor symbol">Use mcp__serena__replace_symbol_body</branch>
    <branch condition="Rename symbol">Use mcp__serena__rename_symbol for consistent updates</branch>
    <branch condition="Add code">Use mcp__serena__insert_before_symbol or mcp__serena__insert_after_symbol</branch>
    <branch condition="Check patterns">Use mcp__serena__list_memories then mcp__serena__read_memory</branch>
    <branch condition="Record patterns">Use mcp__serena__write_memory</branch>
  </decision_tree>
</patterns>
...
<anti_patterns>
  <avoid name="reading_entire_files">
    ...
    <instead>Use mcp__serena__get_symbols_overview for file structure and mcp__serena__find_symbol with include_body for specific implementations</instead>
  </avoid>
  ...
  <avoid name="ignoring_memories">
    ...
    <instead>Always check mcp__serena__list_memories and mcp__serena__read_memory before implementation</instead>
  </avoid>

  <avoid name="manual_refactoring">
    <description>Manually updating symbol references across files</description>
    <instead>Use mcp__serena__rename_symbol for consistent renaming with automatic reference updates</instead>
  </avoid>

  <avoid name="excessive_depth">
    <description>Using high depth values unnecessarily in mcp__serena__get_symbols_overview</description>
...
<workflow>
  <phase name="prepare">
    ...
    <step>1. Check mcp__serena__list_memories for existing patterns</step>
  ...
  <phase name="execute">
    ...
    <step>1. Start with mcp__serena__get_symbols_overview for file structure</step>
    <step>2. Use mcp__serena__find_symbol with include_body for details</step>
    <step>3. Use mcp__serena__find_referencing_symbols for dependencies</step>
  </phase>
  <phase name="verify">
    <objective>Verify results and record patterns</objective>
    <step>1. Call mcp__serena__think_about_collected_information after searches</step>
    <step>2. Record new patterns with mcp__serena__write_memory</step>
    <step>3. Call mcp__serena__think_about_whether_you_are_done when complete</step>
  </phase>
</workflow>

<best_practices>
  <practice priority="critical">Always check memories with mcp__serena__list_memories and mcp__serena__read_memory before implementing new features</practice>
  <practice priority="critical">Use symbol operations (mcp__serena__get_symbols_overview, mcp__serena__find_symbol) over reading entire files</practice>
  ...
  <practice priority="high">Record new patterns and conventions with mcp__serena__write_memory for future reference</practice>
  <practice priority="medium">Use context_lines parameters in mcp__serena__search_for_pattern to understand surrounding code</practice>
  <practice priority="medium">Verify symbol changes with mcp__serena__find_referencing_symbols before refactoring</practice>
</best_practices>
...
<rules priority="critical">
  ...
  <rule>Call mcp__serena__think_about_collected_information after non-trivial search sequences</rule>
  <rule>Call mcp__serena__think_about_task_adherence before making code changes</rule>
</rules>
...
<rules priority="standard">
  ...
  <rule>Record new patterns with mcp__serena__write_memory</rule>
  <rule>Call mcp__serena__think_about_whether_you_are_done when task appears complete</rule>
</rules>
...
<constraints>
  <must>Check memories (mcp__serena__list_memories, mcp__serena__read_memory) before implementing new features</must>
