...
/* airy */
:root {
  --spacing-slide-padding: 7rem;
  --spacing-gap-md: 2.5rem;
}
```
...
<div class="absolute bottom-0 left-0 w-full opacity-10 pointer-events-none">
  <svg viewBox="0 0 1920 200" fill="none" preserveAspectRatio="none" class="w-full h-[200px]">
    <path
      d="M0,100 C320,20 640,180 960,100 C1280,20 1600,180 1920,100 L1920,200 L0,200 Z"
...
<div class="absolute -top-20 -right-20 opacity-[0.06] pointer-events-none">
  <svg width="500" height="500" viewBox="0 0 500 500" fill="none">
    <path
      d="M250,50 C350,20 450,100 430,200 C460,300 380,420 280,440 C180,460 60,380 50,280 C40,180 150,80 250,50Z"
      fill="var(--color-accent)"
    />
  </svg>
</div>
...
<!-- 単一の縦線アクセント -->
<div
  class="absolute top-20 left-16 w-[3px] h-[200px]"
...
<!-- スクリーンショット用 -->
<img
  src="https://placehold.jp/30/e2e8f0/64748b/800x500.png?text=Demo+Screenshot"
  alt="デモ画面"
...
<!-- 人物写真用 -->
<img
  src="https://placehold.jp/30/e2e8f0/64748b/200x200.png?text=Photo"
  alt="メンバー名"
  class="w-48 h-48 rounded-full object-cover"
/>

<!-- ロゴ用 -->
<img src="https://placehold.jp/30/e2e8f0/64748b/200x60.png?text=Logo" alt="ロゴ" class="h-12" />
```
